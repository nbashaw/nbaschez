      ...
      <div className="mx-auto max-w-3xl px-6 pt-10 pb-24">
        <div className="space-y-5 text-[15px] leading-relaxed text-foreground">
              <p>
                ...
                about, and then got acquired by General Assembly, where we
                turned it into{" "}
                <a
              ...
              <p>
                After GA, I co-founded Hardbound (RIP), a visual storytelling
                app that TechCrunch wrote{" "}
                <a
              ...
              <p>
                ...
                for an Alexa Skill. More importantly I was able to occasionally
                sit in the room next to genius editors, producers, and hosts as
                they created some of the best podcasts the world has ever heard.
              </p>

              <p>
                After that, I joined Substack as first employee as they were
                finishing YC. There I built some of the core features you know
                and love, like the little screen that asks for your email before
                you read an article. (Happy to do my part helping writers get
                paid! 😅) I also built a fun system to identify promising
                writers on Twitter, known lovingly as the{" "}
                <a
              ...
              <p>
                ...
                as a fun experiment on nights and weekends, and fell back in
                love with building software after a few years writing. We
                launched it and got 25k+ signups in the first day. It was
                unreal. After that, we spun it out into its own company that I
                have been leading since then. We raised a $2.8M seed round in
                Aug 2023 led by True Ventures, and over 300K writers have used
                our service.
              </p>

              <p>
                These days, I spend my time building and using AI agents, and
                trying to understand what the message of this new medium is. If
                you'd like to get or stay in touch the best place to do so is
                probably Twitter / X, I am{" "}
                <a
